...
public class EngineTestsV2 : EngineTestsBase
{
    ...
    [InlineData(0, 2)]
    [InlineData(0, 10)]
    public async Task TestBacktestingProgressSingleSymbol(int daysPerSplit, int warmupCandlesCount)
    {
        Strategy.ExecuteStrategyDelegateV2 = symbols =>
        {
            _ = symbols;
        ...
        // --- Generate fake SymbolData splitter
        List<List<SymbolDataV2>> data = GenerateSingleSymbolDataList(new DateTime(2023, 1, 1), 1000, daysPerSplit, warmupCandlesCount);
    ...
    [InlineData(3)]
    [InlineData(30)]
    public async Task TestBacktestingProgressSingleSymbolDaysPerSplit0(int warmupCandlesCount)
    {
        // --- Generate fake SymbolData splitter
        List<List<SymbolDataV2>> data = GenerateSingleSymbolDataList(new DateTime(2023, 1, 1),
            1500, daysPerSplit: 0, warmupCandlesCount);
    ...
    [InlineData(3)]
    [InlineData(30)]
    public async Task TestBacktestingProgressMultipleSymbolsDaysPerSplit0(int warmupCandlesCount)
    {
        // --- Generate fake SymbolData splitter
        List<List<SymbolDataV2>> data = GenerateSymbolDataList(new DateTime(2023, 1, 1),
            1500, daysPerSplit: 0, warmupCandlesCount);
    ...
    [InlineData(0, 2)]
    [InlineData(0, 10)]
    public async Task TestBacktestingProgressMultipleSymbols(int daysPerSplit, int warmupCandlesCount)
    {
        // --- Generate fake SymbolData splitter
        List<List<SymbolDataV2>> data = GenerateSymbolDataList(new DateTime(2023, 1, 1), 500, daysPerSplit, warmupCandlesCount);
        ...
        int daysPerSplit, int warmupCandlesCount)
    {
        ...
        List<SymbolDataV2> generatedSymbolsData = GenerateFakeSymbolsDataV2(["BTCUSDT", "ETHUSDT", "SOLUSDT"],
        ...
        int daysPerSplit, int warmupCandlesCount)
    {
        ...
        List<SymbolDataV2> generatedSymbolsData = GenerateFakeSymbolsDataV2(["BTCUSDT"],
            [CandlestickInterval.M5, CandlestickInterval.M15, CandlestickInterval.M30, CandlestickInterval.H1],
            startingDate.AddHours(-warmupCandlesCount), totalCandlesCount);
